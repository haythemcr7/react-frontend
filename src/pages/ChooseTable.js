...
function ChooseTable() {
  ...
  useEffect(() => {
    axios.get("http://authback-backend-production.up.railway.app:5000/tables")
      ...
      <div className="tables-grid">
        {tables.map((t) => (
          ...
          >
            ...
            <img src={`http://authback-backend-production.up.railway.app:3000${t.image_url}`} alt={t.surnom} className="table-logo" />
            <p>{t.surnom}</p>
